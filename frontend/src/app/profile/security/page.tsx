...
// --- Sub-componente: Password Strength Checklist ---
// [REQ-F-01] — Feedback visual en tiempo real de seguridad de contraseña.
// Patrón idéntico al usado en /auth/register y /auth/reset-password (SPEC v1.3.0 — consistencia UX).

interface PasswordStrengthProps {
  password: string;
}

function PasswordStrengthChecklist({ password }: PasswordStrengthProps) {
  const checks = [
    {
